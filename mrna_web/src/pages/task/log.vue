<template>
    <div class="flex flex-col pt-5 px-5 justify-center items-center">
        <div class="mt-10 w-9/10">
        ...
        <div class="mt-15 w-9/10">
            <el-tabs v-model="activeName" class="text-xl" type="card" @tab-click="handletabClick">
                ...
                <el-scrollbar class="h-96 bg-dark p-4 text-light" v-loading="consoleloading">
                    <n-code

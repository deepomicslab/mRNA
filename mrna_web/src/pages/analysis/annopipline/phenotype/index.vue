        ...
        <el-scrollbar class="w-full" ref="scrollbarRef">
            <div class="flex flex-col h-400">
                <div class="font-600 ml-20 mt-16 flex flex-row border-b-2 w-9/10 pb-5">
                    <div class="text-4xl text-[#253959]">Phenotype Annotation</div>
                    <el-button
                        round
                        size="large"
                        color="#EE7E7D"
                ...
                <div class="flex flex-row">
                    ...
                    <div class="ml-20 flex flex-col items-start w-full">
                        <div class="font-600 text-3xl mt-10">1. Input Sequence</div>
                            ...
                            <div class="flex flex-row justify-center ml-2">
                                ...
                                >
                                    <div class="text-lg mb-6 w-190">
                                        ...
                                        <n-button
                                            text
                                            href="https://phagescope.deepomics.org/dataExample/data_demo/J02448.1.fasta"
                                            tag="a"
                                            target="_blank"
                                            type="primary"
                                            class="text-lg"
                        ...
                        <div class="flex flex-col justify-items-center items-center">
                            <div
                                class="rounded w-270 h-130 mt-10 rounded-2xl flex-row flex ml-15"
                                style="box-shadow: 0 0 64px #cfd5db"
                            >
...
const godemo = () => {
    router.push({ path: '/task/result/annopipline', query: { taskid: 51 } })
}
...
const submit = async () => {
    ...
    if (precheck.value) {
        submitdata.append('analysistype', 'Phenotype Annotation')
...
const submitdemo = async () => {
    ...
    modulelist.value.host = true
    modulelist.value.lifestyle = true
    submitdata.append('modulelist', JSON.stringify(modulelist.value))

        ...
        <el-scrollbar class="w-full" ref="scrollbarRef">
            <div class="flex flex-col h-400">
                <div class="font-600 ml-20 mt-16 flex flex-row border-b-2 w-9/10 pb-5">
                    <div class="text-4xl text-[#253959]">Sequence Clustering</div>
                    <el-button
                        round
                        size="large"
                        color="#EE7E7D"
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <n-alert type="info" closable :bordered="false" class="w-180 bg-[#9ab4c5]">
                        ...
                        <p class="text-lg text-gray-50">
                            The number of sequences uploaded to perform genome comparison must
                            exceeds two.
                        </p>
                    </n-alert>
                </div>
...
const submit = async () => {
    ...
    submitdata.append('analysistype', 'Sequence Clustering')
...
const godemo = () => {
    router.push({ path: '/task/result/comparison/cluster', query: { taskid: 170 } })
}

...
const createColumns = (): DataTableColumns<RowData> => [
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'FullName' }), 'FullName')
        },
        key: 'FullName',
        align: 'center',
        sorter: 'default',
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'UniProtID' }), 'UniProtID')
        },
        key: 'UniProtID',
        align: 'center',
        fixed: 'left',
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'NCBIGeneID' }), 'NCBIGeneID')
        },
        key: 'NCBIGeneID',
        align: 'center',
        fixed: 'left',
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'GeneCardID' }), 'GeneCardID')
        },
        key: 'GeneCardID',
        align: 'center',
        fixed: 'left',
    ...
    {
        title() {
            return renderTooltip(h('div', null, { default: () => 'Isoforms' }), 'Isoforms')
        },
        key: 'Isoforms',
        align: 'center',
        sorter: 'default',
    ...
    },
    {
        title() {
            return renderTooltip(
                h('div', null, { default: () => 'RNAorProteinexpressionprofile' }),
                'RNAorProteinexpressionprofile'
            )
        },
        key: 'RNAorProteinexpressionprofile',
        align: 'center',
        fixed: 'left',
        width: 125,
        render(row: any) {
            return h('div', null, [
                h(
                    ...
                    [
                        h(NEllipsis, null, {
                            default: () => {
                                return row.RNAorProteinexpressionprofile
                            },
                        }),
                    ]
                ),
    ...
    },
    {
        title() {
            return renderTooltip(
                h('div', null, { default: () => 'Antigensequence' }),
                'Antigensequence'
            )
        },
        key: 'Antigensequence',

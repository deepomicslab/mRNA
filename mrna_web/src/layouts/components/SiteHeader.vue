...
import { DesignServicesFilled as DesignIcon } from '@vicons/material'
import {
...
const menuOptions: MenuOption[] = [
    ...
    }, */ { label: 'Design', key: '/design', icon: renderIcon(DesignIcon) },
    { label: 'Result', key: '/resultdisplay', icon: renderIcon(DesignIcon) },

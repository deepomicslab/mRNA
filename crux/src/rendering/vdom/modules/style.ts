...
function updateStyle(oldVnode: VNode, vnode: VNode): void {
  let cur: any, name: string, elm = vnode.elm,
...
function applyDestroyStyle(vnode: VNode): void {
  let style: any, name: string, elm = vnode.elm, s = (vnode.data as VNodeData).style;
...
function applyRemoveStyle(vnode: VNode, rm: () => void): void {
  ...
  let name: string, elm = vnode.elm, i = 0, compStyle: CSSStyleDeclaration,
